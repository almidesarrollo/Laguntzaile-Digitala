...
public class AsinLoc extends AsyncTask<Void, Void, String> {
   ...
   //  @Geolocator es la clase que devuelve los puntos obtenidos por el servicio de localizacion
    ...
    public AsinLoc(Context c, SQLiteDatabase db,Handler mHandler)
    {
    ...
    public AsinLoc(Context c, SQLiteDatabase db)
    {
...
/*
    ...
    protected void onCancelled() {
        ...
        geo.Apagar();
       // geo.cancelar();
      //  Toast.makeText(cContext,"ME CANCELO",Toast.LENGTH_LONG).show();
    }
}
