...
public class AsynCad implements SensorEventListener {
    ...
    private SensorManager mnrgSensores;
...
*/
    public AsynCad(Context c, SensorManager mnrgSensor, Handler mHandler)
    {
           maxCad=1000;
        maxMov=0;
        alertCad=0;
        ...
        mnrgSensores.registerListener(this, asensor, SensorManager.SENSOR_DELAY_NORMAL,mHandler);
        mnrgSensores.registerListener(this, msensor, SensorManager.SENSOR_DELAY_NORMAL,mHandler);
    }

    public AsynCad(Context c, SensorManager mnrgSensor)
    {
        maxCad=1000;
        maxMov=0;
        alertCad=0;
...
*/
    ...
    */
        ...
        /*MainGeo.txt5.setText("Normal de datos magneticos "+normH+"\n,Normal de aceleracion"+normsAcec+"\n Acel:x"+datosAccec[0] +"\n Acel:y"+datosAccec[1] +"\n Acel:z"+datosAccec[2]
                +"\n MAXACELELRACION="+maxMov+"\n MAXCAIDA="+maxCad+"\n AceleracionQuePilla="+alertMod+"\n CaidaQuepilla="+alertCad);*/
    }
